            ...
            <form action="../includes/register.php" method="post">
                <div class="pt-3 pb-3 ms-5 me-5">
                    ...
                    <div class="mt-3 mb-3">
                        ...
                        <input type="email" class="form-control" name="password" aria-describedby="emailHelp" required>
                    </div>
                    <div class="mt-3 mb-3">
                        ...
                        <div id="passwordHelpBlock" class="form-text">
                            Your password must be 8-32 characters long, contain letters and numbers, and must not
                            contain spaces or emoji.
                        </div>
                    </div>
                    <div class="mt-3 mb-3">
                        <input type="submit" class="btn btn-outline-secondary mb-3" value="Registrati">
                    </div>
                </div>
        	</form>
		</div>
